...
async def create_session(
    ...
    # To be able to create a session a user_id is required. The user id from the previously created user is used.
    # The start and end time are set to the current time.
    new_session = Session(user_id=user.id, start=now, end=now)
    db.add(new_session)
    db.commit()
